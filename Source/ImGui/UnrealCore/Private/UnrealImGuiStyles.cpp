...
void StyleUnrealDark(ImGuiStyle* dst)
{
    ...
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.35f, 0.35f, 0.35f, 1.00f);
    ...
    colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.35f, 0.35f, 0.35f, 1.00f);
    ...
    colors[ImGuiCol_TableBorderStrong] = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
    colors[ImGuiCol_TableBorderLight] = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
    colors[ImGuiCol_TableRowBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_TableRowBgAlt] = ImVec4(1.00f, 1.00f, 1.00f, 0.06f);
    colors[ImGuiCol_TextSelectedBg] = ImVec4(0.35f, 0.35f, 0.35f, 1.00f);
...
{
    SetStyle(static_cast<EStyle::Type>(GetMutableDefault<UImGuiPerUserSettings>()->StyleIndex), dst);
}
