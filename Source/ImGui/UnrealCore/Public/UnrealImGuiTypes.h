...
ENUM_CLASS_FLAGS(EImGuiWindowFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiChildFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiChildFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiFocusedFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiFocusedFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiHoveredFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiHoveredFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiCond
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiCond::Type);
...
ENUM_CLASS_FLAGS(EImGuiComboFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiSliderFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiSliderFlags::Type);
...
ENUM_CLASS_FLAGS(EImGuiInputTextFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiColorEditFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiColorEditFlags::Type);
...
ENUM_CLASS_FLAGS(EImGuiTreeNodeFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiSelectableFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiSelectableFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiPopupFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiPopupFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiTableFlags
{
	enum Type : int32
	{
	    // Features
...
ENUM_CLASS_FLAGS(EImGuiTableFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiTableRowFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiTableRowFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiTableColumnFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiTableColumnFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiTabBarFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiTabBarFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiTableBgTarget
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiTableBgTarget::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiTabItemFlags
{
	enum Type : int32
	{
...
ENUM_CLASS_FLAGS(EImGuiTabItemFlags::Type);

UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = true))
namespace EImGuiModKey
{
	enum Type : int32
	{
		None     = ImGuiMod_None                   ,
...
ENUM_CLASS_FLAGS(EImGuiModKey::Type);
